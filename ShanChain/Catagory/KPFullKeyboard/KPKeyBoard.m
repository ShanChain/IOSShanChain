...
+ (KPKeyBoard*)shareInstance {
    KPKeyBoard * keyBoard  = [[KPKeyBoard alloc] initWithFrame:CGRectMake(0, [UIScreen mainScreen].bounds.size.height - 262, [UIScreen mainScreen].bounds.size.width, 262)];
    return keyBoard;
}
...
- (UIButton *)confirmButton {
    if(!_confirmButton){
        ...
        [button setFrame:CGRectMake(0, self.frame.size.height-100, [UIScreen mainScreen].bounds.size.width-60, 100)];
...
- (UIButton *)deleteButton {
    if(!_deleteButton){
        UIButton *button  = [UIButton buttonWithType:UIButtonTypeCustom];
        [button setFrame:CGRectMake([UIScreen mainScreen].bounds.size.width-60-1, self.frame.size.height-100, 60-1, 100)];
