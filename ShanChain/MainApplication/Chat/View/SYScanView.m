...
@interface SYScanView()<AVCaptureMetadataOutputObjectsDelegate>{
...
- (void)layoutSubviews{
    ...
    //最上部view
    _upView.frame = CGRectMake((SCREEN_WIDTH - scanViewW) * 0.5, 0, scanViewW, 150);
    //底部view
...
- (void)addAnimation{
    ...
    line.hidden = NO;
    CABasicAnimation *animation = [SYScanView moveYTime:2 fromY:[NSNumber numberWithFloat:4] toY:[NSNumber numberWithFloat:self.scanW -2] rep:OPEN_MAX];
