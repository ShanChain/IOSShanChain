...
+ (void)initialize{
    ...
    //    cell.backgroundColor = RGB(187, 187, 187);
...
- (void)_setupSubview
{
    ...
    _titleLabel.backgroundColor = RGB(187, 187, 187);
...
- (void)_setupTitleLabelConstraints{
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.titleLabel attribute:NSLayoutAttributeRight relatedBy:NSLayoutRelationEqual toItem:self.contentView attribute:NSLayoutAttributeRight multiplier:1.0 constant:-130]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.titleLabel attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self.contentView attribute:NSLayoutAttributeLeft multiplier:1.0 constant:130]];
}
