...
+ (void)initialize{
    ...
    imageView.badgeFont = [UIFont systemFontOfSize:8];
    imageView.imageCornerRadius = 0;
    imageView.badgeSize = 14;
}
...
//        _imageView.frame = CGRectMake(36, 11, 14, 14);
...
//        _badgeView.frame = CGRectMake(36, 11, 14, 14);
...
- (void)_setupBadgeViewConstraint
{
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.badgeView attribute:NSLayoutAttributeRight relatedBy:NSLayoutRelationEqual toItem:self.imageView attribute:NSLayoutAttributeRight multiplier:1.0 constant:-5]];
    
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.badgeView attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.imageView attribute:NSLayoutAttributeTop multiplier:1.0 constant:5]];
}
