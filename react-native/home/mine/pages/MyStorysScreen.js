...
class MyStorys extends Component {
    constructor(props) {
        super(props);
        // 下拉列表的参数
...
const MyStorysScreen = StackNavigator({
        MyStorys: {
            screen: MyStorys,
            navigationOptions: {
                header: ({navigation}) => {
                    return (<CommonHeaderView goBack={() => SCNavigator.pop()} isShowBack={true} navigation={navigation}
                                              title={'我的故事'}></CommonHeaderView>)
                },
            }
        }
    },
    {
        initialRouteName: 'MyStorys'
    });
